...
| /api/authors/:firstName     | GET        |    show            | get a single author by firstname   |
| /api/cookbooks/:title |       GET    |    show            | get a single cookbook by title     |
| /api/cookbooks/year/:yearPublished |       GET    |    show            | get a single cookbook by year     |
